...
--HISTORIAL DE LOS LOGS INACTIVOS QUE TIENEN DUPLICADOS

SELECT *
FROM ADELIA.HL_LOG HL
INNER JOIN (SELECT INACTIVOS.OBJECTID ID_01,
       INACTIVOS.HLL_USE_CLASS CLASE_01,
       INACTIVOS.HLL_USE_SELECTOR SELECTOR_01,
       INACTIVOS.HLL_IS_ACTIVE_USE ACTIVO_01,
       ACTIVOS.OBJECTID ID_02,
...
WHERE 1=1
      AND ACTIVOS.HLL_IS_ACTIVE_USE = 1
) LOGS_DUPLICADOS ON LOGS_DUPLICADOS.ID_01 = HL.HLL_USE